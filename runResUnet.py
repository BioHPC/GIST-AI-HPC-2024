...
if __name__ == "__main__":
    ...
    file_path = "files/"
    model_path = "files/resunet_kvasir-instrument_epoch10.h5" #renamed for clarity
    ...
    train_path = "new_data/kvasir-instrument/train/"
    valid_path = "new_data/kvasir-instrument/valid/"
    ...
    batch_size = 8
    lr = 1e-4
    epochs = 10 #200 #Number of epochs changed
