...
if __name__ == "__main__":
    model_path = "files/resunetplusplus_kvasir-instrument_epoch10.h5"#"files/resunetplusplus_kvasir-instrument.h5"
    save_path = "/student/schmittwf/bio/ML/ResUNetPlusPlus/result/Kvasir-instrument-e10"#"result/Kvasir-SEG/"
    test_path = "/student/schmittwf/bio/ML/ResUNetPlusPlus/new_data/kvasir-instrument/test"# "new_data/kvasir_segmentation_dataset/test/"#new_data/kvasir-instrument/test/
    ...
    model.evaluate(test_gen, steps=test_steps, verbose=1)  #model.evaluate_generator(test_gen, steps=test_steps, verbose=1)
