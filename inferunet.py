...
if __name__ == "__main__":
    model_path = "files/unet_kvasir-instrument_epoch10.h5"#"files/resunetplusplus_kvasir-instrument.h5"
    save_path = "/student/schmittwf/bio/ML/ResUNetPlusPlus/result/unet_kvasir-instrument_e10"#"result/Kvasir-SEG/"
